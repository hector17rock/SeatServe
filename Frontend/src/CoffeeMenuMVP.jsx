...
// --- Brewline Coffee Co. Catalog ---
const CATALOG = [
  { id: "p1", name: "Coffee Small 8oz", price: 2.5, category: "Coffee", station: "Coffee", image: "/Images/coffee-small-8oz.png" },
  { id: "p2", name: "Coffee Large 12oz", price: 3.5, category: "Coffee", station: "Coffee", image: "/Images/coffee-large-12oz.png" },
  { id: "p3", name: "Cold Brew Small 8oz", price: 3.0, category: "Cold Coffee", station: "Coffee", image: "/Images/cold-brew-small-8oz.png" },
  { id: "p4", name: "Cold Brew Large 12oz", price: 4.0, category: "Cold Coffee", station: "Coffee", image: "/Images/cold-brew-large-12oz.png" },
  { id: "p5", name: "Iced Coffee Small 8oz", price: 2.75, category: "Cold Coffee", station: "Coffee", image: "/Images/iced-coffee-small-8oz.png" },
  { id: "p6", name: "Iced Coffee Large 12oz", price: 3.75, category: "Cold Coffee", station: "Coffee", image: "/Images/iced-coffee-large-12oz.png" },
];
...
export default function CoffeeMenuMVP() {
  ...
  const [concessionName] = useState(() => {
    return localStorage.getItem('selected_concession_name') || 'Brewline Coffee Co.';
  });
  ...
  useEffect(() => {
    ...
    if (!DEV) return;
    try {
      console.log("[Brewline Coffee Co.] Running smoke tests...");
      // Currency sanity
      ...
      console.log("[Brewline Coffee Co.] Smoke tests passed ✓");
    } catch (e) {
      console.warn("[Brewline Coffee Co.] Smoke tests failed:", e);
    }
  }, []);
  ...
  return (
    <div className="min-h-screen bg-white text-neutral-900 relative">
      {/* Brewline Coffee Co. Logo Wallpaper */}
      <div 
        className="fixed inset-0 pointer-events-none opacity-25"
        style={{
          backgroundImage: 'url(/Images/brewline-coffee-logo.png)',
