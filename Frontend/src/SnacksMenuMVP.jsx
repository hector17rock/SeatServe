...
// --- Snacks Palace Catalog ---
const CATALOG = [
  { id: "p1", name: "Walking Taco", price: 8.5, category: "Snacks", station: "Assemble", image: "/Images/walking-taco.png" },
  { id: "p2", name: "Popcorn", price: 4.0, category: "Snacks", station: "Booth A", image: "/Images/popcorn.png" },
  { id: "p3", name: "Soft Pretzel", price: 4.5, category: "Snacks", station: "Booth B", image: "/Images/soft-pretzel.png" },
  { id: "p4", name: "Churro", price: 3.5, category: "Snacks", station: "Booth C", image: "/Images/churro.png" },
  { id: "p5", name: "Soda Small 16oz", price: 2.5, category: "Drinks", station: "Beverage", image: "/Images/soda-small-16oz.png" },
  { id: "p6", name: "Soda Medium 21oz", price: 3.0, category: "Drinks", station: "Beverage", image: "/Images/soda-medium-21oz.png" },
  { id: "p7", name: "Soda Large 32oz", price: 3.5, category: "Drinks", station: "Beverage", image: "/Images/soda-large-32oz.png" },
  { id: "p8", name: "Bottled Water", price: 2.5, category: "Drinks", station: "Beverage", image: "/Images/bottled-water.png" },
];
...
export default function SnacksMenuMVP() {
  ...
  const [concessionName, setConcessionName] = useState(() => {
    return localStorage.getItem('selected_concession_name') || 'Snacks Palace';
  });
  ...
  useEffect(() => {
    ...
    if (!DEV) return;
    try {
      console.log("[Snacks Palace] Running smoke tests...");
      // Currency sanity
      ...
      console.log("[Snacks Palace] Smoke tests passed ✓");
    } catch (e) {
      console.warn("[Snacks Palace] Smoke tests failed:", e);
    }
  }, []);
  ...
  return (
    <div className="min-h-screen bg-white text-neutral-900 relative">
      {/* Snack Palace Logo Wallpaper */}
      <div 
        className="fixed inset-0 pointer-events-none opacity-25"
        style={{
          backgroundImage: 'url(/Images/snack-palace-logo.png)',
