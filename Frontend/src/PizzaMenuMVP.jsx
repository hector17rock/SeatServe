...
// --- Napoli Pizza Catalog ---
const CATALOG = [
  { id: "p1", name: "Cheese Pizza Slice", price: 5.5, category: "Pizza", station: "Oven", image: "/Images/cheese-pizza-slice.png" },
  { id: "p2", name: "Breadsticks", price: 4.0, category: "Sides", station: "Oven", image: "/Images/breadsticks.png" },
  { id: "p3", name: "Pepperoni Pizza Slice", price: 6.5, category: "Pizza", station: "Oven", image: "/Images/pepperoni-pizza-slice.png" },
...
export default function PizzaMenuMVP() {
  ...
  useEffect(() => {
    ...
    if (!DEV) return;
    try {
      console.log("[Napoli Pizza] Running smoke tests...");
      // Currency sanity
      ...
      console.log("[Napoli Pizza] Smoke tests passed ✓");
    } catch (e) {
      console.warn("[Napoli Pizza] Smoke tests failed:", e);
    }
  }, []);
  ...
  return (
    <div className="min-h-screen bg-white text-neutral-900 relative">
      {/* Napoli Pizza Logo Wallpaper */}
      <div 
        className="fixed inset-0 pointer-events-none opacity-25"
        style={{
          backgroundImage: 'url(/Images/napoli-pizza-logo.png)',
